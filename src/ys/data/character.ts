...
export default <ICharacterData>{
    ...
    "Wanderer": {
        ...
        "presets": ["攻双暴"],
        "build": {
            "set": ["DesertPavilionChronicle", "ShimenawasReminiscence", "EchoesOfAnOffering", "ViridescentVenerer", "GladiatorsFinale"],
            "main": {
                "sands": ["atkp"],
                "goblet": ["anemoDB", "atkp"],
                "circlet": ["cr", "cd"]
    ...
    "Faruzan": {
        ...
        "presets": ["攻双暴", "攻充双暴", "充"],
        "build": {
            "set": ["NoblesseOblige", "TenacityOfTheMillelith", "ViridescentVenerer"],
            "main": {
                "sands": ["er", "atkp"],
                "goblet": ["anemoDB", "atkp"],
                "circlet": ["cr", "cd"]
