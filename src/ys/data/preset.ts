...
export default <IPresetData>{
    ...
    "攻生精双暴": { hp: 0, atk: 0, def: 0, hpp: 1, atkp: .5, defp: 0, em: 1, er: 0, cr: 1, cd: 1 },
    ...
    "攻防双暴": { hp: 0, atk: 0, def: 0, hpp: 0, atkp: .5, defp: 1, em: 0, er: 0, cr: 1, cd: 1 },
    "攻防充双暴": { hp: 0, atk: 0, def: 0, hpp: 0, atkp: .5, defp: 1, em: 0, er: 1, cr: 1, cd: 1 },
