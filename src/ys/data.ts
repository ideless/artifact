...
export default <IData>{
    ...
    mainWeight: {
        'flower':{'hp': { p: 1, v: 1 }},
        'plume':{'atk': { p: 1, v: 1 }},
        'sands':{'atkp': { p: 0.74, v: 0.2666 },
                'hpp': { p: 0.14, v: 0.2666 },
                'defp': { p: 0.1, v: 0.2666 },
                'er': { p: 0.52, v: 0.1 },
                'em': { p: 0.26, v: 0.1 }},
        'goblet':{'atkp': { p: 0.28, v: 0.2125 },
                'hpp': { p: 0.12, v: 0.2125 },
                'defp': { p: 0.08, v: 0.2 },
                'pyroDB': { p: 0.125, v: 0.05 },
                'hydroDB': { p: 0.125, v: 0.05 },
                'electroDB': { p: 0.125, v: 0.05 },
                'anemoDB': { p: 0.125, v: 0.05 },
                'cryoDB': { p: 0.125, v: 0.05 },
                'geoDB': { p: 0.125, v: 0.05 },
                'physicalDB': { p: 0.125, v: 0.05 },
                'em': { p: 0.14, v: 0.025 }},
        'circlet':{'atkp': { p: 0.16, v: 0.22 },
                'hpp': { p: 0.1, v: 0.22 },
                'defp': { p: 0.08, v: 0.22 },
                'cr': { p: 0.8, v: 0.1 },
                'cd': { p: 0.78, v: 0.1 },
